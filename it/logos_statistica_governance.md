...
Da un punto di vista ingegneristico, gli LLM rappresentano la validazione empirica più radicale della tesi wittgensteiniana secondo cui "il significato è l'uso". Quando addestriamo un modello per costruire uno Spazio Vettoriale Multidimensionale (Embedding), non stiamo facendo altro che tradurre i "giochi linguistici" in geometria. Un vettore non codifica la verità logica di un concetto, ma le coordinate statistiche del suo utilizzo. Il modello predice il token successivo semplicemente calcolando la distanza tra questi usi nello spazio vettoriale, imitando perfettamente le regole del gioco senza mai giocarlo nella realtà.

Ma è qui che risiede il problema dell'IA Generativa. Gli LLM possono generare la frase "Verrò dopodomani" con una sintassi perfetta. Ma, proprio come il cane di Wittgenstein, non abitano il tempo. Non hanno una Forma di Vita. Per un'IA, "dopodomani" non è un'attesa o un impegno verso il futuro, è solo una probabilità statistica che segue la parola "verrò".
